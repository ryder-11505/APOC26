 ...
 */
@Disabled
public class BaseAuto_DO_NOT_EDIT extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // ===================================================================
        drive(24, 0, DEFAULT_POWER);     // drive forward 24"
        turn(45, DEFAULT_POWER);         // turn 45° clockwise

        turret.track(0.0, 0.0);                  // aim turret (degrees, offset)
        double rpm = turret.aimForDistance(1200.0); // sets hood + returns target RPM
        shooter.setPower(rpm, false);             // spin up shooter
        shooter.toggleGate();                     // open gate to fire
        sleep(1000);                              // let it fire — replace with real timing/logic
        shooter.stopShoot();
        ...
        drive(12, 12, DEFAULT_POWER);    // diagonal move (forward+strafe combined)
