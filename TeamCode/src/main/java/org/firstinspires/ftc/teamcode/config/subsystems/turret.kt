...
//        )
        ...
        val HOOD_TABLE = listOf(
            Triple(600.0,  1.0000, 1050.0),
            Triple(800.0,  1.0000, 1100.0),
            Triple(1000.0, 0.9700, 1100.0),
            Triple(1200.0, 0.9400, 1150.0),
            Triple(1400.0, 0.8900, 1150.0),
            Triple(1600.0, 0.8900, 1200.0),
            Triple(1800.0, 0.8600, 1250.0),
            Triple(2000.0, 0.7600, 1300.0),
            Triple(2200.0, 0.7600, 1350.0),
            Triple(2400.0, 0.7500, 1350.0),
            Triple(2600.0, 0.7200, 1450.0),
            Triple(2800.0, 0.7000, 1450.0),
            Triple(3000.0, 0.7000, 1450.0),
        )
    }
